...
import pl.seafta.persistance.email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(@NotNull AccountRequest request) {
        ...
        String link = "http://localhost:8080/Account/registration/confirm?token=" + token;
